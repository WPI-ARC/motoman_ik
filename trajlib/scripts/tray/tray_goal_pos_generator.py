...
def seed_state_generator():
	...
	Goal1.jnt_val = [2.608074188232422, -0.29658669233322144, 
					 0.8934586644172668, 1.7289633750915527, 
					 1.573803424835205, 1.2867212295532227, 
					 1.4699939489364624, -3.129976219106093];
	...
	# test:-2.7764135704468327, -2.991207336328638, -0.3328773892667774, 0.46831510120599845, -1.9604224720237644, 1.003934790591375, -0.6123129278142971, 0.8552516343894233
	Goal4 = config_goal();
	Goal4.bin_num = "D";
	...
	#Goal7.jnt_val = [2.4718597530192796,1.1048811085600885, 1.8289698505492917, -2.1170583249526715, -2.089052808535928, -2.178255911290856, 1.5745535013303766, -1.735037580794114];
	seed_state_set.append(Goal7);
	
	Goal8 = config_goal();
	Goal8.bin_num = "H";
	Goal8.jnt_val = [2.89966156482696533, 1.8770301342010498, 1.2306787967681885, -0.586269199848175, 2.2546935081481934, 1.669684886932373, 1.7160991430282593, 0.7149554491043091];
