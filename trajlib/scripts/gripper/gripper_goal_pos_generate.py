...
def generate_Pick_points(Bin_base_x, 
	...
	binA.x = Entry_X_shiftvalue - 0.02;
	...
	binB_entrance.x = Entry_X_shiftvalue - 0.03;
	...
	binE_entrance.x = 0.32;
	binE_entrance.y = Bin_base_y;
	binE_entrance.z = Bin_base_z + Level3 + Z_shift_value + 0.05;
	...
	binE_entrance.qx = -0.49351;
	binE_entrance.qy = 0.36314;
	binE_entrance.qz = 0.61905;
	binE_entrance.qw = -0.49128;
	...
	# binG_entrance.x = 0.34289; 
	# binG_entrance.y = 0.34123; 
	# binG_entrance.z = 1.1011;
	...
	# binI_entrance.x = 0.32304; 
	# binI_entrance.y =-0.20629; 
	# binI_entrance.z = 1.1407;
	
	binI_entrance.qx = 0.49436;
	binI_entrance.qy = -0.41356;
	binI_entrance.qz = -0.57737;
	binI_entrance.qw =  0.50122;
	...
	binJ_entrance.x = Entry_X_shiftvalue - 0.05;
	binJ_entrance.y = Bin_base_y + Left_horizontal_ShiftValue;
	binJ_entrance.z = Bin_base_z + Level1;
	
	#binJ_entrance.x = 0.232;
	#binJ_entrance.y = 0.412;
	#binJ_entrance.z = 0.866;	
	...
	binL_entrance.y = Bin_base_y - Right_horizontal_ShiftValue - 0.03;
	binL_entrance.z = Bin_base_z + Level1;
	
	#binL_entrance.x = 0.33436; 
	#binL_entrance.y = -0.35794; 
	#binL_entrance.z = 0.94033;
	...
	#binL_entrance.qx = 0.59578;
	#binL_entrance.qy = -0.35231
	#binL_entrance.qz = -0.47611
	#binL_entrance.qw = 0.54244
...
def generate_left_arm_torso_seed_state():
    ...
    Goal5.bin_num = 'E';    
    Goal5.jnt_val = [0.5356912271252465, 1.760340814983384, -1.1042616346848957, -0.23659808479520741, 2.158461366529147, 1.6885361196369675, -1.2098072847600962, 2.9861716033935903]
    #Goal5.jnt_val = [-1.3974423541925325, -0.863634922798586, 1.8999960341326425, 1.906840099309606, 2.0359141364272015, -2.3056172497606697, -1.8708573543301303, -0.12300377843874667];
    seed_state.append(Goal5);
    
    Goal6 = Jnt_state_goal();
    Goal6.bin_num = 'F';
    Goal6.jnt_val = [2.2565497859407753, -2.850489396435261, 1.2727725448929177, -2.559277171440135, 1.8775398170974813, 2.084178224681629, 1.1724738598120166, -2.6107799391022986];
    ...
    Goal7.bin_num = 'G';
    #Goal7.jnt_val = [0.8525443076324624, -1.0030338411388136, -1.4997057055841438, 0.4574008584487667, -2.1772850485982387, 0.4509690249055915, -1.2042788502320196, -1.5582129550341324];
    Goal7.jnt_val = [-1.4470763980509713, -2.4546403694939154, 1.8351989667760573, -1.3913660429380645, -1.6072073829343216, -2.014907856262033, 1.8144296456152158, 1.9682414521621932];
    ...
    Goal8.jnt_val = [-1.8636731204458847, -1.456620356275983, 1.7729055661744468, 2.143805737338475, 2.1763523257881046, -2.277758897506118, -1.44205404543251, -0.7346582338785187];
    seed_state.append(Goal8);
    
    Goal9 = Jnt_state_goal();
    Goal9.bin_num = 'I';
    Goal9.jnt_val = [2.221965151188681, -0.6878961764618825, -1.2206410031468728, -2.5012561077218214, -1.9824500298498293, 2.583058159127863, -0.7681903167755327, 0.9885230343632632];
    #Goal9.jnt_val = [2.7594388126454716, -1.0030338411388136, -1.4997057055841438, 0.4574008584487667, -2.1772850485982387, 0.4509690249055915, -1.2042788502320196, -1.5582129550341324];
    seed_state.append(Goal9);
    
    Goal10 = Jnt_state_goal();
    Goal10.bin_num = 'J';
    Goal10.jnt_val = [0.7766167607578884, -1.003025987408744, -1.4998825947919632, 0.4574561717794226, -2.1772683167031515, 0.4510542655871075, -1.2043286962667494, -1.558219805014673];
    ...
    Goal12.jnt_val = [2.207678097329874, -1.1041323441453081, -1.0834609251494425, -2.6250328028526546, -1.7812198821860925, 2.805286923436219, -0.20669781967716772, 1.1040078397365465];
...
# ----------------------- E ----------------------------
    ...
    binE_entrance.y = Bin_base_y;
    binE_entrance.z = Bin_base_z + Level3 + 0.02;
    binE_entrance.qx = default_orientation_x;
    binE_entrance.qy = default_orientation_y;
    binE_entrance.qz = default_orientation_z;
    binE_entrance.qw = default_orientation_w;
